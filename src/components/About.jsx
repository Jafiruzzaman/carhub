        ...
        <div className="flex items-center xl:flex-row md:flex-row  flex-col justify-center xl:justify-between xl:items-start xl:gap-24 gap-8 text-center">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <Image
              src={AboutIMage}
              alt="car image"
              className="w-[400px] md:w-[1200px] xl:w-full z-10"
            />
          </div>
          {/* text */}
          <div className="xl:text-left md:text-left text-left">
            <h3 className="h2 xl:text-6xl text-4xl max-w-[24rem] xl:max-w-[32rem] font-extrabold leading-snug ">
              why should you <span className="text-orangePrimary">choose</span>{" "}
              us
            </h3>
            <p className="p text-balance text-sm px-2  xl:text-base xl:max-w-[27rem] capitalize">
              Choose a rental car location near your accommodation or major
              transport hubs like airports and train stations for convenience,
              ease of access, and a wider selection of vehicles.
            </p>
          </div>
        </div>
      </div>
